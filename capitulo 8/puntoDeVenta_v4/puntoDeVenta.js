calcularValorTotal = function () {
    ...
    let precio; // SE UTILIZA PARA RECUPERAR EL PRECIO COMO FLOAT
    let monto; // SE UTILIZA PARA RECUPERAR EL PRECIO COMO FLOAT
    ...
    monto=recuperarFloat("txtPrecio");
   
    valorDescuento = calcularValorDescuento(monto, porcentajeDescuento);
