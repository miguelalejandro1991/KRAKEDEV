...
calcular1 = function () {
    ...
    if (isNaN(nota1)) {
        alert("Nota 1 no es un número válido");
    } else {
        nota2 = recuperarFloat("txtNota2");
        if (isNaN(nota2)) {
            alert("Nota 2 no es un número válido");
        } else {
            nota3 = recuperarFloat("txtNota3");
            if (isNaN(nota3)) {
                alert("Nota 3 no es un número válido");
            } else {
...
calcular2 = function () {
    ...
    nota1 = recuperarFloat("txtNota1");
    if (isNaN(nota1)) {
        mostrarTexto("lblError1", "DEBE INGRESAR UN NÚMERO VÁLIDO");
        existeError = true;
    } else {
    ...
    nota2 = recuperarFloat("txtNota2");
    if (isNaN(nota2)) {
        mostrarTexto("lblError2", "DEBE INGRESAR UN NÚMERO VÁLIDO");
        existeError = true;
    } else {
    ...
    nota3 = recuperarFloat("txtNota3");
    if (isNaN(nota3)) {
        mostrarTexto("lblError3", "DEBE INGRESAR UN NÚMERO VÁLIDO");
        existeError = true;
    } else {
